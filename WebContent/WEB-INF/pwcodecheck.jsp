  ...
  <!-- 왼쪽 네비 시작 -->
	...
	<div id="right-panel" class="right-panel">
        ...
        <div class="container"><!-- 좌우측의 공간 확보 -->
            ...
            <form class="form-horizontal" role="form" method="post" action="pwcheckProc.member">
                <div class="form-group" id="divpwcheck">
                    <label for="inputid" class="col-lg-2 control-label">코드입력</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="checkpwcode" name="pwcodecheck" data-rule-required="true" placeholder="메일로 온 코드를 입력하세요" maxlength="30" required>
