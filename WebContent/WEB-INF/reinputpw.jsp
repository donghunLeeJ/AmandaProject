  ...
  <!-- 왼쪽 네비 시작 -->
						...
						<c:otherwise>
							<li id="charge" class="menu-item-has-children"><a
								href="page?url=WEB-INF/pay.jsp"> <i
									class="menu-icon fa fa-usd fa-lgㄴ"></i>충전하기
							</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
	...
	<div id="right-panel" class="right-panel">
        ...
        <div class="container"><!-- 좌우측의 공간 확보 -->
            ...
            <form class="form-horizontal" role="form" method="post" action="pwcompleteProc.member">
                <div class="form-group" id="divpwcheck">
                    <label for="inputid" class="col-lg-2 control-label">비밀번호 입력</label>
                    <div class="col-lg-10">
                        <input type="password" class="form-control" id="reinputpwarea" name="reinputpw" data-rule-required="true" placeholder="영어 대,소문자 숫자로 8글자 이상" maxlength="30" pattern="[0-9a-zA-z]{8,}" required>
                        <input type="hidden" name="pw_id" value="${pw_id }">
                        <input type="hidden" name="pw_email" value="${pw_email }">
                    </div>
                </div>
