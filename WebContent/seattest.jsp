...
<!doctype html>
	...
	<div id="right-panel" class="right-panel">
		...
		<header id="header" class="header">
            ...
            <div class="content ">
                ...
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat1">
                            <div class="card" style="height: 80%">
                                <h4>1 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat2">
                            <div class="card" style="height: 80%">
                                <h4>2 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat3">
                            <div class="card" style="height: 80%">
                               <h4>3 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat4">
                            <div class="card" style="height: 80%">
                                <h4>4<br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat5">
                            <div class="card" style="height: 80%">
                             <h4>5 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat6">
                            <div class="card" style="height: 80%">
                             <h4>6 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat7">
                            <div class="card" style="height: 80%">
                               <h4>7 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat8">
                            <div class="card" style="height: 80%">
                             <h4>8 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat9">
                            <div class="card" style="height: 80%">
                               <h4>9 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat10">
                            <div class="card" style="height: 80%">
                               <h4>10 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat11">
                            <div class="card" style="height: 80%">
                             <h4>11 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat12">
                            <div class="card" style="height: 80%">
                             <h4>12 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat13">
                            <div class="card" style="height: 80%">
                               <h4>13 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat14">
                            <div class="card" style="height: 80%">
                             <h4>14 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat15">
                            <div class="card" style="height: 80%">
                             <h4>15 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat16">
                            <div class="card" style="height: 80%">
                              <h4>16 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat17">
                            <div class="card" style="height: 80%">
                                  <h4>17 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat18">
                            <div class="card" style="height: 80%">
                                 <h4>18 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat19"> 
                            <div class="card" style="height: 80%">
                                   <h4>19 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat20">
                            <div class="card" style="height: 80%">
                                 <h4>20 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat21">
                            <div class="card" style="height: 80%">
                                  <h4>21 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat22">
                            <div class="card" style="height: 80%">
                                  <h4>22 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat23">
                            <div class="card" style="height: 80%">
                                 <h4>23 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat24">
                            <div class="card" style="height: 80%">
                                  <h4>24 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-2 col-2" id="seat25">
                            <div class="card" style="height: 80%">
                                   <h4>25 <br><br></h4>
                            </div><!-- /# card -->
                        </div>
         ...
         <c:forEach var="i" items="${SeatList}">       
         <script>             
         if(${i.comusecheck}==1){
